<?php include('partials_front/nav_bar.php');?>
    ...
    <?php   
        ...
        $in_fname = $ROW3['in_fname'];
        $in_lname = $ROW3['in_lname'];        
        ...
        <div class="container">
            ...
            <form action="#" class="order">
                ...
                <fieldset>
                    ...
                    <input type="text" name="in_fname" value="<?php echo $in_fname;?>" class="input-responsive" required>
                    
                    <div class="order-label">Last Name</div>
                    <input type="text" name="in_flame" value="<?php echo $in_lname;?>" class="input-responsive" required>
